...
const Page = () => {
  ...
  const pinataApiKey = "PINATA_KEY";
  const pinataSecretApiKey =
    "PINATA_SECRET_KEY";

  const contractAddress = "0xd5bE64cFf96179f68602fc77Da75c91DC3737203";
  ...
  const notarizeDocument = async () => {
    ...
    try {
      ...
      const tx = await contract.notarizeDocument(bytes32, { gasLimit: 300000 });
